...
export function HeroSection() {
  ...
  const handleDownloadResume = () => {
    ...
    link.href = '/Afreen_Alam_Resume.pdf'; // Assuming resume is in public folder
    link.download = 'Afreen_Alam_Cybersecurity_Resume.pdf';
  ...
  const handleEmailClick = () => {
    window.location.href = 'mailto:alamafreen93@gmail.com?subject=Hello Afreen&body=Hi Afreen, I would like to connect with you.';
  };

  const handlePhoneClick = () => {
    window.location.href = 'tel:+919324208312';
  };
          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            >
              <motion.button
                ...
                className="px-8 py-4 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-full font-semibold text-white shadow-2xl shadow-blue-500/25 hover:shadow-blue-500/40 transition-all duration-300 backdrop-blur-sm border border-white/10 cursor-pointer"
              >
                View My Work
              </motion.button>
              <motion.button
                ...
                className="px-8 py-4 border-2 border-white/20 rounded-full font-semibold text-slate-300 hover:text-white hover:bg-white/10 hover:border-white/30 transition-all duration-300 backdrop-blur-sm shadow-xl cursor-pointer"
              >
                Download Resume
              </motion.button>
            </motion.div>
            ...
            >
              <div 
                className="flex items-center gap-2 hover:text-slate-300 transition-colors duration-200 cursor-pointer"
