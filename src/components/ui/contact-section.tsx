          ...
          {contactMethods.map((method, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group bg-gradient-to-br from-slate-900/80 to-slate-800/50 border-slate-700/50 backdrop-blur-md hover:scale-105 transition-all duration-300 rounded-2xl border overflow-hidden"
              >
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 rounded-full font-semibold text-white shadow-2xl hover:shadow-cyan-500/25 transition-all duration-300"
            >
              Get In Touch
            </motion.button>
          </div>
